	...
	<body>
		...
		<div class="container mycont"> 
			...
			<div class="panel panel-default">
				<div class="panel-heading">Rapport: "Consommation par programmeur"</div>
				<div class="panel-body">
					<p class="text-left">
						<?php
							//Compte combien de tasses de cafe le programmeur demandé a consomme
							$sumDeTasses=0;
							$nomCons=$_POST['nom'];
							foreach ($arrayStat as $jourKey => $jourValue){
								if (array_key_exists($nomCons, $jourValue)){
										$sumDeTasses+=$jourValue[$nomCons];
								}
							}
							echo $nomCons." a consommé ".$sumDeTasses." tasses";
						?>
					</p>
